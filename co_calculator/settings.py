"""
Django settings for co_calculator project.
...
ROOT_URLCONF = 'co_calculator.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "co_calculator" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'co_calculator.wsgi.application'
...
EMAIL_HOST = os.environ.get('EMAIL_HOST', 'smtp.bizmail.yahoo.com')
